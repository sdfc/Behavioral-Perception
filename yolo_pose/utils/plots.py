...
from yolo_pose.utils.general import xywh2xyxy, xyxy2xywh
from yolo_pose.utils.metrics import fitness
...
def plot_skeleton_kpts(im, kpts, steps, orig_shape=None):
    ...
    skeleton = [[12, 13], [6, 12], [7, 13], [6, 8], [7, 9], [8, 10], [9, 11]]

    pose_limb_color = palette[[9, 9, 9, 9, 7, 7, 7, 7, 0, 0, 0, 0, 16, 16, 16, 16, 16, 16, 16]]
    pose_kpt_color = palette[[16, 16, 16, 16, 16, 0, 0, 0, 0, 0, 0, 9, 9, 9, 9, 9, 9]]

    radius = 5
    num_kpts = len(kpts) // steps  # num_kpts=17

    for kid in range(5, num_kpts-4):
